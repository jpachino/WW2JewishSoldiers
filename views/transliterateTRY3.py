...
# Main processing
def main():
    parser = argparse.ArgumentParser(description="Transliterate English to Hebrew using phonemes or API.")
    parser.add_argument('--method', choices=['phoneme', 'api'], default='phoneme', help='Transliteration method')
